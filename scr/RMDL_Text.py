...
def Text_classification(Data_text,Random_Deep,n_epochs,batch_size,sparse_categorical,EMBEDDING_DIM,MAX_NB_WORDS,MAX_SEQUENCE_LENGTH):

    y_proba = []
    History = []
    score = []
    X_train, X_train_M, y_train, X_test, X_test_M, y_test, word_index, embeddings_index, number_of_classes = Data_load.Load_data(Data_text,
