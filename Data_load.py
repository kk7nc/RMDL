...
def Load_data(fname, fnamek,MAX_NB_WORDS,MAX_SEQUENCE_LENGTH):
    data=0
    if data ==0:
        ...
        X_train_M, X_test_M, word_index, embeddings_index = loadData_Tokenizer(X, X_t, MAX_NB_WORDS, MAX_SEQUENCE_LENGTH)
    else:
        if(data == 1):
    ...
    return (X_train,X_train_M, y_train,X_test, X_test_M, y_test, word_index, embeddings_index)
